...
public class NpcEntity extends PathfinderMob {
	public static final EntityDataAccessor<String> DATA_Skin = SynchedEntityData.defineId(NpcEntity.class, EntityDataSerializers.STRING);

	public NpcEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SkywizaModEntities.NPC.get(), world);
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(NpcEntity.this.getId());
					return new NpcGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
