...
public class LootChestRemoverBlock extends Block {
	...
	public void appendHoverText(ItemStack itemstack, BlockGetter level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("block.skywiza.loot_chest_remover.description_0"));
		list.add(Component.translatable("block.skywiza.loot_chest_remover.description_1"));
		list.add(Component.translatable("block.skywiza.loot_chest_remover.description_2"));
	}
