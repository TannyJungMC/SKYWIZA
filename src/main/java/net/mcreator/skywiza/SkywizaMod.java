...
import net.mcreator.skywiza.world.features.StructureFeature;
import net.mcreator.skywiza.init.SkywizaModTabs;
import net.mcreator.skywiza.init.SkywizaModMenus;
import net.mcreator.skywiza.init.SkywizaModItems;
import net.mcreator.skywiza.init.SkywizaModEntities;
import net.mcreator.skywiza.init.SkywizaModBlocks;
import net.mcreator.skywiza.init.SkywizaModBlockEntities;
...
@Mod("skywiza")
public class SkywizaMod {
	public static final Logger LOGGER = LogManager.getLogger(SkywizaMod.class);
	public static final String MODID = "skywiza";
	...
	public SkywizaMod() {
		...
		SkywizaModBlocks.REGISTRY.register(bus);
		SkywizaModBlockEntities.REGISTRY.register(bus);
		SkywizaModItems.REGISTRY.register(bus);
		SkywizaModEntities.REGISTRY.register(bus);

		SkywizaModTabs.REGISTRY.register(bus);

		StructureFeature.REGISTRY.register(bus);

		SkywizaModMenus.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									SkywizaMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			SkywizaMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
